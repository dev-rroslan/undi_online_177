defmodule UndiOnline.UsersTest do
  ...
  describe "register_user/1" do
    ...
    test "creates the personal account" do
      ...
      assert %UndiOnline.Accounts.Account{personal: true} = user.personal_account
      assert [%UndiOnline.Accounts.Membership{role: :owner}] = user.memberships
    end
  end
